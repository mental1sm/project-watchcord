...
export class Guild {
  ...
  name: string;
  @ApiProperty({description: 'Discord icon file name', example: '6dacb838c4fa409aae7c1f908ac8c6a1'})
  @Column({name: 'icon', type: 'text', nullable: true})
  icon: string;

  @Column({name: 'owner_id', type: 'text', nullable: true})
  @ApiProperty({description: 'Owner member id', example: '1287831564524454010'})
  owner_id: string;
