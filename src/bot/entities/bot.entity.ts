...
export class Bot extends BaseEntity {
  ...
  token: string;
  @ApiProperty({description: 'Bot username', example: 'Project WatchCord Servitor'})
  @Column({name: 'name', type: 'text', nullable: true})
  username: string;
  @ApiProperty({description: 'ID of avatar in Discord CDN', example: '6dacb838c4fa409aae7c1f908ac8c6a1'})
